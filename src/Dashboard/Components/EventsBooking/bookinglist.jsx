...
const EventBookingList = () => {
  ...
  const fetchEventBookings = async () => {
    try {
      ...
      console.error("Error fetching eventBookings", error);
    }
  };
  console.log("eventBookings", eventBooking);
  useEffect(() => {
    fetchEventBookings();
  }, [])
          ...
          <div className="dataTables_wrapper no-footer">
            <table className="border-collapse table card-table display mb-4 shadow-hover default-table dataTablesCard dataTable no-footer">
              ...
              <tbody>
                ...
                {eventBooking.map((booking, index) => (
                  ...
                  >
                    <td><span className="text-nowrap">EBL-00{booking.id}</span></td>
                    ...
                    <td><span className="text-nowrap">{booking.booked_date}</span></td>
                    <td><span className="text-nowrap">{booking.time}</span></td>
                    <td><span className="text-nowrap">{booking.no_of_guests}</span></td>
                    <td><span className="text-nowrap">{booking.menu}</span></td>
                    <td><span className="text-nowrap">{booking.custom_stage}</span></td>
